...
<div style="padding:10px 10px 10px 10px">
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        ...
	        <tr>
	            0<td>商品标题:</td>                                     <!-- data-options="required:true"  该项必填 -->
	        ...
	        <tr>
	            ...
	            <td><input class="easyui-numberbox" type="text" name="priceView" data-options="min:1,max:99999999,precision:2,required:true" />
	            	<input type="hidden" name="price"/><!-- hidden 隐藏 -->
	            </td>
	        </tr>
	        <tr>
	            <td>库存数量:</td>
...
<script type="text/javascript">
	...
	function submitForm(){
		...
		//转化价格单位，将元转化为分 $("元素").val();取值     $("元素").val("100")赋值    eval(字符串):将数据转化为js对象  "100"*100--100*100
		...
		*/
		//alert($("#itemAddForm").serialize());//表单序列化提交参数
